---
title: Jevin学数据结构之二叉树
date: 2023-01-01 21:20:31
tags: 数据结构
categories: 数据结构与算法
...
[![pSCH8fO.jpg](https://s1.ax1x.com/2023/01/01/pSCH8fO.jpg)](https://imgse.com/i/pSCH8fO)

你有没有发现，“树”这种数据结构真的很像我们现实生活中的“树”，这里面每个元素我们叫作“节点”；用来连线相邻节点之间的关系，我们叫作“父子关系”。

比如下面这幅图，A 节点就是 B 节点的**父节点**，B 节点是 A 节点的**子节点**。B、C、D 这三个节点的父节点是同一个节点，所以它们之间互称为**兄弟节点**。我们把没有父节点的节点叫作**根节点**，也就是图中的节点 E。我们把没有子节点的节点叫作**叶子节点**或者**叶节点**，比如图中的 G、H、I、J、K、L 都是叶子节点。

[![pSCHd0I.jpg](https://s1.ax1x.com/2023/01/01/pSCHd0I.jpg)](https://imgse.com/i/pSCHd0I)

除此之外，关于“树”，还有三个比较相似的概念：**高度**（Height）、**深度**（Depth）、**层**（Level）。它们的定义是这样的：

[![pSCHy9S.jpg](https://s1.ax1x.com/2023/01/01/pSCHy9S.jpg)](https://imgse.com/i/pSCHy9S)

这三个概念的定义比较容易混淆，描述起来也比较空洞。我举个例子说明一下，你一看应该就能明白。

[![pSCHgXj.jpg](https://s1.ax1x.com/2023/01/01/pSCHgXj.jpg)](https://imgse.com/i/pSCHgXj)
...
[![pSCHf7q.jpg](https://s1.ax1x.com/2023/01/01/pSCHf7q.jpg)](https://imgse.com/i/pSCHf7q)
...
[![pSCH4A0.jpg](https://s1.ax1x.com/2023/01/01/pSCH4A0.jpg)](https://imgse.com/i/pSCH4A0)
...
[![pSCHT9U.jpg](https://s1.ax1x.com/2023/01/01/pSCHT9U.jpg)](https://imgse.com/i/pSCHT9U)
...
[![pSCHHc4.jpg](https://s1.ax1x.com/2023/01/01/pSCHHc4.jpg)](https://imgse.com/i/pSCHHc4)
...
[![pSCHbjJ.jpg](https://s1.ax1x.com/2023/01/01/pSCHbjJ.jpg)](https://imgse.com/i/pSCHbjJ)
...
[![pSCHLu9.jpg](https://s1.ax1x.com/2023/01/01/pSCHLu9.jpg)](https://imgse.com/i/pSCHLu9)
...
[![pSCHXH1.jpg](https://s1.ax1x.com/2023/01/01/pSCHXH1.jpg)](https://imgse.com/i/pSCHXH1)

### 1. 二叉查找树的查找操作

首先，我们看如何在二叉查找树中查找一个节点。我们先取根节点，如果它等于我们要查找的数据，那就返回。如果要查找的数据比根节点的值小，那就在左子树中递归查找；如果要查找的数据比根节点的值大，那就在右子树中递归查找。

[![pSCHvAx.jpg](https://s1.ax1x.com/2023/01/01/pSCHvAx.jpg)](https://imgse.com/i/pSCHvAx)
...
[![pSCHxN6.jpg](https://s1.ax1x.com/2023/01/01/pSCHxN6.jpg)](https://imgse.com/i/pSCHxN6)
...
[![pSCbp9O.jpg](https://s1.ax1x.com/2023/01/01/pSCbp9O.jpg)](https://imgse.com/i/pSCbp9O)
...
[![pSCb93D.jpg](https://s1.ax1x.com/2023/01/01/pSCb93D.jpg)](https://imgse.com/i/pSCb93D)

当要查找数据的时候，遇到值相同的节点，我们并不停止查找操作，而是继续在右子树中查找，直到遇到叶子节点，才停止。这样就可以把键值等于要查找值的所有节点都找出来。

[![pSCbPjH.jpg](https://s1.ax1x.com/2023/01/01/pSCbPjH.jpg)](https://imgse.com/i/pSCbPjH)

对于删除操作，我们也需要先查找到每个要删除的节点，然后再按前面讲的删除操作的方法，依次删除。

[![pSCbAHI.jpg](https://s1.ax1x.com/2023/01/01/pSCbAHI.jpg)](https://imgse.com/i/pSCbAHI)
...
[![pSCbZUP.jpg](https://s1.ax1x.com/2023/01/01/pSCbZUP.jpg)](https://imgse.com/i/pSCbZUP)
